...
const PageFooter: FC = () => (
  <footer className='mt-3 flex h-[120px] w-full items-center justify-center'>
    <div className='flex w-full gap-[50px] p-[30px] sm:ml-[40px] sm:gap-[100px] sm:p-[60px]'>
      ...
      <div className='flex gap-10'>
        ...
        <div>
          <p className='text-small text-black/60 dark:text-white/60'>Support</p>
          <div className='mt-2 space-y-1'>
            <Link className='block text-tiny hover:underline' href='/about'>
              Buy us a coffee
            </Link>
      ...
      <div className='ml-[610px] mt-10 space-y-3'>
