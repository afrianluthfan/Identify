  ...
  return (
    <section className='relative h-[700px] items-center justify-center'>
      ...
      <div className='flex flex-col items-center justify-center'>
        <Card>
          <Image src='/pita-rainbow.png' alt='gay' height={600} width={1245} className='absolute blur-sm' />
          ...
          <CardBody className='grid grid-cols-6 p-8 w-[1245px] h-[600px] overflow-hidden'>
            <div className='col-span-2'>
              ...
              <div className='flex font-bold mt-[120%] my-3 text-xl'>
                Issued at{' '}
            ...
            <div className='col-span-4 grid grid-cols-3 grid-rows-2'>
              <div className='relative col-span-2 items-center text-center justify-center'>
                <div className='absolute left-36 top-32'>asdadasd</div>
              </div>
              ...
              <div className='text-2xl'>Danceability</div>
