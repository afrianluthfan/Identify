        ...
        data?.map((track) => (
          ...
          >
            <Image
              ...
              width={300}
            />
            <CardFooter className='before:bg-white/10 border-white/20 border-1 overflow-hidden py-2 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] h-[70px] shadow-small ml-1 z-10 bg-slate-700 bg-opacity-70'>
