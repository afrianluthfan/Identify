...
const AudioFeatures: FC = () => {
  ...
  return (
    <div>
      <h1>Happiness: {scaledValence}</h1>
      <h1>Danceability: {scaledDanceability}</h1>
      <h1>Energy: {scaledEnergy}</h1>
      <h1>Accousticness: {scaledAccousticness}</h1>
      <h1>Speechiness: {scaledSpeechiness}</h1>
    </div>
  );
};
